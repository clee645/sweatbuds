...
// Survivor heads-up when an active partnership ends (partner deleted their
// account, was removed, or unpaired). Neutral, name-free copy mirroring
// PartnerJoinedToast.
export function PartnerLeftToast({ onHidden }: Props) {
  ...
  useEffect(() => {
    ...
    // Run once per mount; new toasts get a fresh component via the host's key.
